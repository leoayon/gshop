  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="toggleShowInfo">
    ...
    <div class="shop-header-discounts" @click="toggleShowDiscounts" v-if="shopInfo.supports">
      <div class="discounts-left">
        <div class="activity" :class="activityClasses[shopInfo.supports[0].type]">
          <span class="content-tag">
            <span class="mini-tag">
      ...
      <div class="discounts-right">{{shopInfo.supports.length}}个优惠</div></div>
      ...
      <div class="shop-brief-modal" v-show="showInfo">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="toggleShowInfo"></span>
          </div>
        </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="showDiscounts">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item" :class="activityClasses[support.type]"
          ...
          <div class="activity-sheet-close">
            <span class="iconfont icon-close" @click="toggleShowDiscounts"></span>
          </div>
        </div>
